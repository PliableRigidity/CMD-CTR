...
_HERMES_TOOLS = [
    ...
    {"name": "get_node_info", "description": "Get info about a specific node", "parameters": {"type": "object", "properties": {"node": {"type": "string"}}, "required": ["node"]}},
    {"name": "ping_node", "description": "Ping/check if a node is online", "parameters": {"type": "object", "properties": {"node": {"type": "string"}}, "required": ["node"]}},
    {"name": "get_node_telemetry", "description": "Get CPU/RAM/disk/battery telemetry for a node. Use node='all' for all nodes", "parameters": {"type": "object", "properties": {"node": {"type": "string"}}, "required": ["node"]}},
